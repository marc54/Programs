...
void closest(int[], int, int);                                   //Function Prototype6
...
int main()
{
   ...
   do
    ...
    if (arrnum==1)
        closest(score1, arrval, n);
    else if (arrnum==2)
        closest(score2, arrval, n);
    else if (arrnum==3)
        closest(score3, arrval, n);
    else if (arrnum==4)
        closest(sumscores, arrval, n);
...
//Function6
void closest(int arr[], int searchval, int m )
{
...
if (arr[0]>searchval)
    cout<<"0";
if else(arr[m-1]<searchval)
    cout<< m-1;
if else(arr[x]==seachval)
    cout<< x;
if else(arr[x]<searchval && arr[x+1]>searchval)
    cout<<x<<" and " x+1;
